...
class EatScriptGuiNode {
  ...
  EatScriptGuiNode copyWith({
    ...
    return EatScriptGuiNode(
      ...
      backgroundStyle: clearBackgroundStyle ? null : (backgroundStyle ?? this.backgroundStyle),
...
class EatScriptGuiPanelDef {
  ...
  EatScriptGuiPanelDef copyWith({
    ...
    double? textureScale,
    String? sideCheeks,
    bool clearSideCheeks = false,
    double? cornerRadius,
    String? backgroundSvg,
    bool clearBackgroundSvg = false,
    ...
    return EatScriptGuiPanelDef(
      ...
      textureRotation: textureRotation ?? this.textureRotation,
      textureScale: textureScale ?? this.textureScale,
      sideCheeks: (clearSideCheeks || sideCheeks == 'none') ? null : (sideCheeks ?? this.sideCheeks),
      cornerRadius: cornerRadius ?? this.cornerRadius,
      backgroundSvg: clearBackgroundSvg ? null : (backgroundSvg ?? this.backgroundSvg),
