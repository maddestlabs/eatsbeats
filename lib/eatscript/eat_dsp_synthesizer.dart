  ...
  static Float32List synthesizeBuffer({
    ...
    if (code.contains('ConcertGrandPiano') ||
      ...
      return GraphEvaluator.evaluate(
        ...
        note: note,
        params: params,
        velocity: isAccent && velocity <= 0.85 ? (velocity * 1.2).clamp(0.0, 1.0) : velocity,
        isAccent: isAccent,
        isSlide: isSlide,
        targetMidiNote: targetMidiNote,
        articulation: articulation,
    ...
    if (code.contains('EatsFXRain') ||
      ...
      return GraphEvaluator.evaluate(
        root: GraphEvaluator.buildEatsFXRainSynth(),
        durationSec: durationSec,
        freq: freq,
        note: note,
        params: params,
    ...
    if (code.contains('EatsFXWind') ||
      ...
      return GraphEvaluator.evaluate(
        root: GraphEvaluator.buildEatsFXWindSynth(),
        durationSec: durationSec,
        freq: freq,
        note: note,
        params: params,
    ...
    if (code.contains('EatsFXFire') ||
      ...
      return GraphEvaluator.evaluate(
        root: GraphEvaluator.buildEatsFXFireSynth(),
        durationSec: durationSec,
        freq: freq,
        note: note,
        params: params,
