...
import 'package:eatsbeats/eatscript/eats_token.dart';
import 'package:eatsbeats/eatscript/eats_lexer.dart';
import 'package:eatsbeats/eatscript/eats_parser.dart';
...
import 'package:eatsbeats/eatscript/eats_transpiler.dart';
...
''';
      ...
      expect(jsonStr.contains('Midnight Bites'), isTrue);
      expect(jsonStr.contains('Eats Kick'), isTrue);
      expect(File('lib/eatscript/eats_default_song.dart').existsSync(), isTrue);
    });
